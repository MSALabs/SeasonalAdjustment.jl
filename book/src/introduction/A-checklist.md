...
No prose. Chapter 16's taxonomy in operational form — what to check, which
function, what value to want, what to do when it fails.

![Diagnostic checklist flowchart](../../figures/out/fig-intro-E13-checklist-flowchart.png)
...
**None of these is a certificate on its own** — Chapter 16's whole argument
is that the battery exists because no single test, and no single pass,
can be. Read several together, and expect them to occasionally disagree.
